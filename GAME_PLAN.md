...
- [x] M9 — Ship it: `bun run build` clean, README, GitHub repo created + pushed, deployed to free static hosting, live URL verified — DONE: repo https://github.com/Alexi5000/titanic-iceberg-run, GitHub Pages CI (bun build) green, live + browser-verified at https://alexi5000.github.io/titanic-iceberg-run/

LOOP_COMPLETE — all milestones shipped. Live URL: https://alexi5000.github.io/titanic-iceberg-run/
